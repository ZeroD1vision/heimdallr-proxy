...
# Прибиваем процесс и чистим временные файлы на сервере.
stop-test: ## Остановить тест на сервере и удалить все временные файлы
